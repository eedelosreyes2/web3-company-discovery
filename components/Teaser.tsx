...
const Teaser: React.FC<{ company: CompanyProps }> = ({ company }) => {
    const { id, name, description, about, logoUrl, blockchains, tags } =
        company;
    ...
    return (
        <>
            <div
                className="transform transition duration-200 flex flex-col justify-between hover:scale-105 relative cursor-pointer bg-slate-800 border border-slate-700 rounded-lg h-[200px] w-[384px] max-w-sm p-6"
